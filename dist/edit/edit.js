...
class EditPage {
    ...
    onPageLoad() {
        const button = AppButtons.createButton(`${this.pageId}-actionbutton`, "Save");
        ...
        AppButtons.attachListenerToButton(`${this.pageId}-actionbutton`, this.onSaveDocument.bind(this));
    }
    onSaveDocument() {
